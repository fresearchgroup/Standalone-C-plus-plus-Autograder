//Program to accept 2 numbers from the user and then add or subtract the 2 numbers based on the choice (a or s) given by the user. The answer should be stored in the variable 'arithmeticResult'. For an invalid choice, the answer should be -999
